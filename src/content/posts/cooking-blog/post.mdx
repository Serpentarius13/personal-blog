...
People were thinking about interactivity from the start. It made websites alive! And JavaScript provided that, even while being a tricky language. But as everybody probably thinks now, JavaScript could actually slow down user's experience. It is especially aparent on mobile devices as parsing and executing code eben highly optimized by bundlers is consuming battery charge and taking the small network resources they have. Unlike images and static HTML which could be cached, [JavaScript must be re-used and re-executed each time it loads](https://webperf.tips/tip/cached-js-misconceptions/)
