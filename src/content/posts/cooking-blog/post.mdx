...
[`Vercel`](https://vercel.com/home) was my pick, because it is easy and free to publish any project of yours. Just host on Github, link it in dashboard and get free CI/CD, probably not the worst domain name according to your project name if its unique enough (last minute I decided to grab the current domain at [Namecheap](https://www.namecheap.com/), since it was, well, cheap), SSL is handled for you and so on. Free plan is awesome!
