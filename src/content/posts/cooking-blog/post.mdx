...
import { HighlightCat } from "./HighlightCat.tsx";
...
<Image src={webapp}  alt="Web app" widths={[400, 700]} sizes="(max-width: 1024px) 400px, 700px" />  
...
<HighlightCat client:load/> to see him! My personal orange 🐈
