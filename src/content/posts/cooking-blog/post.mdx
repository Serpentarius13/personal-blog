...
So, when choosing a technology, don't bother much (unless explicitly very required) with all the intricacies of bundle size, because you must make it simple and get it working first. And when you're done, you can optimize it anyways.
