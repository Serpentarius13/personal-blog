...
with sound effects and the urge to steal was like never before. You may have seen the result of this, angry, or maybe happy now.
...
So, what choice have I made around ten-thousands ORMs and other solutions to fetch a database nowadays? `Prisma`, of course, as I used
it a lot in production and I don't need any performance - just to pat a cat once in a lifetime! For hosting provider,
as my pocket money are my pocket money, I have chosen to go free: [`Supabase`](ADDLINK) offers free `postgres` hosting forever,
