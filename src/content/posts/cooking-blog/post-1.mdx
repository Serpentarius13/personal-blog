...
and an API to call this search from the client. While blazingly-fast sounds cool, I found it difficult to work with as it
required me to prebuild my documents and use cumbersome js-only lib on the client
