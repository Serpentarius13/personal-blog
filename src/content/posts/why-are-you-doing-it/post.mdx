...
description: "Why do you wake up at 7 am? Why do you have two coffee cups with anime girls printed on them? Why do you hail Rust? Here, I want to think about why ever bother thinking about it, and why what happens when we do."
date: 2024-11-20
draft: false
---
...
I think this question is something that could be asked about pretty much anything in life. Why do you wake up at 7 am? Why do you have two coffee cups with anime girls printed on them? Why are you afraid of people? Why do you even brush your teeth? And it is very reasonable to think about it deeply, because you may discover a thing or two about yourself, and, at the same time, if you ponder on the meaning of toothbrush for 10 hours, then I suggest there's something you can change in your life.
...
I won't get into strange, and probably unknown details of group think (as I'm not a social psychologist), and I don't mean to make this article negative. There is enough negativity on social media and controversies and debates, like, [should you use Typescript? I don't think so, its now removed from this repository you use!](https://world.hey.com/dhh/turbo-8-is-dropping-typescript-70165c01) or "you must write everything by TDD and make your functions 15 lines long", otherwise all hell will break lose.

People, just as I did right now with the passive-aggressive quoting of Uncle Bob, are probably made to be angry about statements that they do not support. But I think most problems can be resolved without raging at your opponent, and in this article I wanted to make a case for me, and maybe for others, about why you may want to learn deeply about the things you're using daily, to withstand all the hot takes and grow a little more independent.

## Introduce some unknowns

Why use the tool? What problems does it solve? How it originated, when, under which circumstances? That's the kind of questions you may want to ask yourself from time to time. They will introduce some blind spots that you had already, but bringing it to the forefront of your attention, so you can address them. 
...
So, I propose that we all ask questions and do something. What I mean by that is it's important to fulfill your business' goals, and at the same time do not degrade into an advanced form builder with the knowledge of SQL's `SELECT` statement. Ask to know yourself and your tech better, and do not slack while doing so incessantly. Arguments ahead!
...
And all these frameworks stood the test of time, especially in the applications where they were meant to be used.
...
Regardless of that, it may be worthwhile to look outside of your place, and having understood what a `Monad` is, you will write your Angular's `RxJS` much better. While doing so, do not do this in a futile way. An interview may be a valid reason, and that's somehow stupid, but don't make it your life sentence to learn about damn monads. Research what you really like, I think what's important is doing it from time to time, and being curious.

## Ignorance is bliss

There's another side of the coin I mentioned at the beginning of this article: business goals. Remember, that if you're working, or even if you're making your personal project, you may have a goal or two, where you might want to get in a certain period of time. That's great to have a time estimate, because it sets a clear boundary for your brain to count upon, and that reduces procrastination a lot. With that, your limitations show up. You can't get it working in time if you sit and read the documentation.
...
I've recently viewed another developer's resume, and it was great, shiny and well-formulated, but one part especially touched my heart and made me laugh, partly because I am the same, but over time less so. When he was listing technologies he had worked with in a job he had, at the end it was like so: "...JavaScript, Vue, PHP (I'm not proud about it)". It really shows certain developer immaturity and imposed elitism of using something and not using something else, when in fact those technologies are not "good" and "bad", they are just different, and are being used to reach different means.
